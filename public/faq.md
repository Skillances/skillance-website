...
> Plain-text FAQ mirror for https://skillance.co.za/faq. Organised by audience: Customers, Freelancers, and Other (press, investors, partnerships). This file is optimised for AI assistants and search engines.

Canonical page: https://skillance.co.za/faq
...
**What is Skillance?**
Skillance is a South African marketplace that connects customers with local, verified freelancers for on-demand services — plumbers, tutors, cleaners, designers, pet carers, and more. You search, you book, the freelancer shows up, and you pay through the app.

**How is Skillance different from a classifieds site?**
We verify every freelancer's ID and profile photo before they can take bookings. Pricing, reviews, and in-app messaging (once a booking is accepted) all live inside Skillance, so both sides know what they're getting into and there's a record if anything goes wrong.

**Is it free to use as a customer?**
...
**How long until a freelancer accepts?**
...
**Can I book more than one freelancer?**
...
**When can I message a freelancer?**
After the freelancer accepts your booking. Skillance opens the chat thread at that point so messages are tied to a confirmed job and there's a clear record. Before acceptance, put the important details in your booking request (scope, access, timing).

**Can I book for a later date?**
...
You agree on scope using the booking flow: submit a request with a clear description and the freelancer's listed rate. After they accept, use in-app messages to clarify details. If the job changes, the freelancer can send a price update through the app for you to approve.

**What if the freelancer doesn't show up?**
...
Yes. Free cancellation more than 4 hours before the booking start time. Inside that window the freelancer keeps a small protection fee to cover their reserved time. You can always reschedule from inside the booking details screen.
...
**What's the Skillance service fee?**
...
**What if I raise a chargeback with my bank?**
...
**How do you verify freelancers?**
Every freelancer goes through South African ID verification and profile-photo matching before they can take bookings. Skillance does not require trade certifications — we're a ratings-and-reviews marketplace, so anyone can register and customers judge quality from public reviews left by previous clients. A verified badge appears on profiles once ID verification is complete.

**Is Skillance POPIA-compliant?**
Yes. We only collect personal information that's necessary to run the marketplace, we store it securely, and we never sell it. Full details live in our Privacy Policy at https://skillance.co.za/privacy-policy.
...
We use strictly necessary cookies for the site to work, and (with your consent) basic analytics to improve it. Manage everything on our Cookie Policy page at https://skillance.co.za/cookie-policy.
...
**How do I report a freelancer's behaviour?**
...
## For Freelancers (offering services)

### Skillance in brief

**What is Skillance for me?**
...
**Is listing free? What does Skillance charge?**
Signing up and listing services is free. Skillance only earns when you do — we deduct a service fee of 8–9% including VAT from confirmed bookings. Exact line items appear before the customer checks out.
...
**How do cancellations work (both sides)?**
...
### Sign-up, verification & day-to-day
...
**Ratings & reviews (how customers judge you)**
...
**What if I'm rejected during verification?**
...
Free cancellations more than 4 hours before the booking. Inside that window, a small protection fee is paid to you automatically to cover the slot you reserved.

### Payments, fees & escrow

**What's the Skillance service fee on my jobs?**
8–9% including VAT on each confirmed booking. It's deducted before your payout. The customer sees the full breakdown at checkout; there are no surprise deductions on your side beyond what's shown there.

**When do payouts reach my bank?**
...
**How does escrow work for my bookings?**
...
**What if the customer gets a refund?**
If a booking is fully refunded, Skillance doesn't keep a commission on that booking and you don't receive that payout. If it's partial, platform commission is calculated only on the amount the customer ultimately pays — not on the refunded slice.

**What if a customer does a chargeback?**
Tell us immediately via support. We review the booking record, chat, and PIN logs. Chargebacks don't override our Terms; abuse can lead to account action.

### Safety, privacy & support

**How does Skillance verify freelancers?**
Every freelancer goes through South African ID verification and profile-photo matching before they can take bookings. Skillance doesn't require trade certifications — the platform runs on ratings and reviews, so anyone can register and build a reputation through real bookings.

**POPIA compliance**
Skillance is POPIA-compliant. We only collect what we need to run the marketplace and pay you, we store it securely, and we never sell it. Full details at https://skillance.co.za/privacy-policy.

**What do customers see about me?**
Customers see your public profile, ratings, and booking-relevant details — not your private banking or ID documents.
...
**How do I report a customer's behaviour?**
...
Funds stay in escrow while our team reviews chat, PIN evidence, and both sides' submissions. Outcomes follow our Terms and South African consumer law.
...
## Other (press, investors, partnerships, general)
...
**How is it different from classifieds?**
ID-verified freelancers, transparent pricing, escrow payments, in-app messaging after a booking is accepted, and public ratings/reviews — so there's a clear record and support path if something goes wrong.
...
Email services@skillance.co.za with "Investment" in the subject line. Include a short introduction.
...
Canonical: https://skillance.co.za/faq
