...
import { UserCheck, Mail, Calendar, Eye, Shield } from 'lucide-react'
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        const response = await get(`/admin/customers?${params.toString()}`)
        ...
        <CardContent>
          {isLoading ? (
            ...
            <EmptyState
              ...
              message={hasActiveFilters ? "Try adjusting your filters to see more results." : "No customers have been registered yet."}
            />
          ) : (
            <>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {customers.map((customer) => (
                      <tr key={customer.id} className="border-b border-border hover:bg-gray-50 transition-colors">
