  ...
  const idColumns: Column<PendingFreelancer>[] = [
    ...
    { key: 'actions', header: 'Actions', render: (f) => (
      <div className="flex items-center gap-1">
        <Button size="sm" variant="ghost" className="h-7 px-2 text-neutral-400 hover:text-black" onClick={(e) => { e.stopPropagation(); navigate(`/admin/freelancers/${f.id}`); }}><Eye className="h-3.5 w-3.5" /></Button>
